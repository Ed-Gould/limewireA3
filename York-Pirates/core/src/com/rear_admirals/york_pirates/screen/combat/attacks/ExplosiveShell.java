...
public class ExplosiveShell extends Attack{
    ...
    public static Attack attackExplosive = new ExplosiveShell("Explosive Shell","Dangerous cannonball. Has a chance to explode on own ship, causing half damage. ", 16,24, false, 65, 1);
}
